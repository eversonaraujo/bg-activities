...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/AllowCorsSubscriber.php';
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/JsonSubmitSubscriber.php';
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ($this->privates['doctrine.dbal.connection_factory'] ?? ($this->privates['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([])))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '8', 'defaultTableOptions' => []], ($this->privates['doctrine.dbal.default_connection.configuration'] ?? $this->getDoctrine_Dbal_DefaultConnection_ConfigurationService()), ($this->privates['doctrine.dbal.default_connection.event_manager'] ?? $this->getDoctrine_Dbal_DefaultConnection_EventManagerService()), []);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\AllowCorsSubscriber'] ?? ($this->privates['App\\EventSubscriber\\AllowCorsSubscriber'] = new \App\EventSubscriber\AllowCorsSubscriber()));
        ...
        $instance->addListener('kernel.controller', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\JsonSubmitSubscriber'] ?? ($this->privates['App\\EventSubscriber\\JsonSubmitSubscriber'] = new \App\EventSubscriber\JsonSubmitSubscriber()));
        }, 1 => 'convertJsonStringToArray'], 0);
        $instance->addListener('Symfony\\Component\\Notifier\\Event\\MessageEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PluginSubscriber'] ?? ($this->privates['App\\EventSubscriber\\PluginSubscriber'] = new \App\EventSubscriber\PluginSubscriber()));
        }, 1 => 'onMessageEvent'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\AllowCorsSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\AllowCorsSubscriber
     */
    protected function getAllowCorsSubscriberService()
    {
        return $this->privates['App\\EventSubscriber\\AllowCorsSubscriber'] = new \App\EventSubscriber\AllowCorsSubscriber();
    }

    /**
     * Gets the private 'App\EventSubscriber\JsonSubmitSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\JsonSubmitSubscriber
     */
    protected function getJsonSubmitSubscriberService()
    {
        return $this->privates['App\\EventSubscriber\\JsonSubmitSubscriber'] = new \App\EventSubscriber\JsonSubmitSubscriber();
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j4X3k7d2Nj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KLPH8U2tDk', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ep7jDE2wAR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tZAv9yo7bz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J1JiMx-pzx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kdu9+ZxHEL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6b9zZVvatl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DCXyf5JpId', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        return $this->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EventSubscriber\\UserProfileSubscriber' => ['privates', 'App\\EventSubscriber\\UserProfileSubscriber', 'getUserProfileSubscriberService', true],
            ...
            'App\\EventSubscriber\\UserProfileSubscriber' => '?',
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
        ]), [0 => 'App\\EventSubscriber\\UserProfileSubscriber', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 3 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
    ...
    {
        $this->privates['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 2).'/log/test.log'), 100, true, NULL, false);
    ...
    private $loadedDynamicParameters = [
        ...
        'google_recaptcha_site_url' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'app_frontend_url': $value = $this->getEnv('APP_FRONTEND_URL'); break;
            case 'google_recaptcha_secret': $value = $this->getEnv('GOOGLE_RECAPTCHA_SECRET'); break;
            case 'google_recaptcha_site_url': $value = $this->getEnv('GOOGLE_RECAPTCHA_ENDPOINT'); break;
