...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 3), ($container->privates['security.exception_listener.main'] ?? $container->load('getSecurity_ExceptionListener_MainService')), NULL, ($container->privates['security.firewall.map.config.main'] ?? $container->load('getSecurity_Firewall_Map_Config_MainService')));
    }
}
