...
class Project extends \App\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'owner', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'tasks', '' . "\0" . 'App\\Entity\\Project' . "\0" . 'createdAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setOwner(?\App\Entity\UserProfile $owner): \App\Entity\Project
    {
